...
export const UI_VIEWMODE_DEV_PLACEHOLDER = "UI_VIEWMODE_DEV_PLACEHOLDER";
...
export const UI_TOPBAR_WEATHER = "UI_CLIMATE_SELECT_WEATHER";
...
export const UI_PALLETE_MODE_SPECIAL = "UI_PALETTE_MODE_SPECIAL";
...
let _GAMEDATA_DEFAULT = {
    ...
    UI_GAME_MAX_CANVAS_SQUARES_X: 0,
    UI_GAME_MAX_CANVAS_SQUARES_Y: 0,
    ...
    UI_SM_GODMODE: false,
    UI_CLIMATE_RAINFALL_DENSITY: 100,
    ...
    UI_LIGHTING_WATER_VALUE: .45,
    UI_LIGHTING_WATER_OPACITY: 0.33,
    UI_LIGHTING_WATER_SATURATION: .5,
    UI_CANVAS_VIEWPORT_CENTER_X: 50,
    UI_CANVAS_VIEWPORT_CENTER_Y: 50,
