...
export const UI_ORGANISM_ORG_ID = "UI_ORGANISM_ORG_ID";
export const UI_ORGANISM_SELECT = "UI_ORGANISM_SELECT";
export const UI_ORGANISM_LINEAGE_MAP = "UI_ORGANISM_LINEAGE_MAP"

export const UI_ORGANISM_GRASS_WHEAT = "UI_ORGANISM_GRASS_WHEAT";
export const UI_ORGANISM_GRASS_BASE = "UI_ORGANISM_GRASS_BASE";
...
export const UI_VIEWMODE_ORGANISM_SUIT_LIGHT = "UI_VIEWMODE_ORGANISM_SUIT_LIGHT";
export const UI_VIEWMODE_ORGANISM_SUIT_WATER = "UI_VIEWMODE_ORGANISM_SUIT_WATER";
export const UI_VIEWMODE_ORGANISM_SUIT_NET = "UI_VIEWMODE_ORGANISM_SUIT_NET";
...
export const UI_VIEWMODE_CANDIDATE = "UI_VIEWMODE_CANDIDATE";
export const UI_VIEWMODE_TARGET = "UI_VIEWMODE_TARGET";
export const UI_VIEWMODE_BLOCK_HEALTH = "UI_VIEWMODE_BLOCK_HEALTH";
export const UI_VIEWMODE_BLOCK_SPEED = "UI_VIEWMODE_BLOCK_SPEED";
export const UI_VIEWMODE_PATH_HISTORY = "UI_VIEWMODE_PATH_HISTORY";


export const UI_CONFIG_VIEWMODE_SUIT_OPACITY = "UI_CONFIG_VIEWMODE_SUIT_OPACITY";
...
export const UI_VISUALIZER_MODE = "UI_VISUALIZER_MODE";
export const UI_VISUALIZER_MODE_LITERAL = "UI_VISUALIZER_MODE_LITERAL";
export const UI_VISUALIZER_MODE_NORMALIZED = "UI_VISUALIZER_MODE_NORMALIZED";
export const UI_VISUALIZER_MODE_HISTORY = "UI_VISUALIZER_MODE_HISTORY";

export const UI_EVOLUTION_ACTIVE_PARAM = "UI_EVOLUTION_ACTIVE_PARAM";
...
export let _GAMEDATA_DEFAULT = {
    ...
    "UI_LIGHTING_DECAY": 0.8166666666666667,
    "UI_LIGHTING_DISABLED_BRIGHTNESS": 0.54,
    "UI_LIGHTING_ENABLED": true,
    "UI_LIGHTING_FLATLIGHTING_BRIGHTNESS": -4.979166666666667,
    "UI_LIGHTING_FLATLIGHTING_HUE": 125,
    "UI_LIGHTING_FLATLIGHTING_SATURATION": 0.95,
    "UI_LIGHTING_GLOBAL": 840,
    "UI_LIGHTING_MOON": -0.979,
    "UI_LIGHTING_PLANT": 8.127777777777778,
    "UI_LIGHTING_PLANT_GRASS": 1.5,
    "UI_LIGHTING_PLANT_TREE": -0.1777777777777778,
    "UI_LIGHTING_QUALITY": 5,
    "UI_LIGHTING_ROCK": -1.7777777777777777,
    "UI_LIGHTING_SCENE_MODE": "UI_LIGHTING_SCENE_MODE_DECAY",
    "UI_LIGHTING_SHADOW_SOFTNESS": 0.05,
    "UI_LIGHTING_SUN": 0.1555555555555559,
    "UI_LIGHTING_SURFACE": 0.46153846153846156,
    "UI_LIGHTING_UPDATERATE": 8,
    ...
    "UI_ORGANISM_NUTRITION_CONFIGURATOR_DATA": {
        ...
        "UI_ORGANISM_GRASS_BASE": {
            ...
            "_waterPressureSoilTarget": -3.6863905325443787,
            "_llt_min": 0.5034023668639054,
            "_llt_max": 1.6664201183431955,
            "_waterPressureOverwaterThresh": 2.061834319526627,
            "_lightDecayValue": 6.02917899408284,
            "_lightLevelDisplayExposureAdjustment": 0.029585798816567976,
            "_lsqColorVarianceMult": 4.238165680473372,
            "_lsqColorVarianceSpeed": 7.041420118343197,
            "_waterPressureWiltThresh": -2.0337278106508876
        },
...
let UI_NEWWORLD_ALLOWLIST = [UI_TEXTEDIT_ACTIVE, UI_MAIN_NEWWORLD, UI_MAIN_NEWWORLD_LATITUDE, UI_MAIN_NEWWORLD_LONGITUDE, UI_MAIN_NEWWORLD_NAME, UI_MAIN_NEWWORLD_TYPE_SELECT, UI_MAIN_NEWWORLD_SIMHEIGHT, UI_CAMERA_EXPOSURE, UI_CLIMATE_RAINFALL_DENSITY]
