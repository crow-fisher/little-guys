...
export const UI_PLOTCONTAINER_ACTIVE = "UI_PLOTCONTAINER_ACTIVE";
export const UI_PLOTCONTAINER_WIDTH = "UI_PLOTCONTAINER_WIDTH";
export const UI_PLOTCONTAINER_HEIGHT = "UI_PLOTCONTAINER_HEIGHT";
export const UI_PLOTCONTAINER_MAXPOINTS = "UI_PLOTCONTAINER_MAXPOINTS";
export const UI_PLOTCONTAINER_XKEY = "UI_PLOTCONTAINER_XKEY";
export const UI_PLOTCONTAINER_YKEY = "UI_PLOTCONTAINER_YKEY";
export const UI_PLOTCONTAINER_ZOOM_X = "UI_PLOTCONTAINER_ZOOM_X";
export const UI_PLOTCONTAINER_ZOOM_Y = "UI_PLOTCONTAINER_ZOOM_Y";
export const UI_PLOTCONTAINER_OFFSET_X = "UI_PLOTCONTAINER_OFFSET_X";
export const UI_PLOTCONTAINER_OFFSET_Y = "UI_PLOTCONTAINER_OFFSET_Y";
export const UI_PLOTCONTAINER_SELECTRADIUS = "UI_PLOTCONTAINER_SELECTRADIUS";

export const UI_PLOTCONTAINER_FILTERMODE_GRAPH = "UI_PLOTCONTAINER_FILTERMODE_GRAPH";
export const UI_PLOTCONTAINER_FILTERMODE_STARS = "UI_PLOTCONTAINER_FILTERMODE_STARS";
export const UI_PLOTCONTAINER_IDSYSTEM_STARS = "UI_PLOTCONTAINER_IDSYSTEM_STARS";
export const UI_PLOTCONTAINER_IDSYSTEM_GRAPH = "UI_PLOTCONTAINER_IDSYSTEM_GRAPH";
export const UI_PLOTCONTAINER_HIDEGRAPH = "UI_PLOTCONTAINER_HIDEGRAPH";
export const UI_PLOTCONTAINER_HIDECONTROLS = "UI_PLOTCONTAINER_HIDECONTROLS";

export const UI_PLOTCONTAINER_TOOLBOX_STAR_STYLE = "UI_PLOTCONTAINER_TOOLBOX_STAR_STYLE";
export const UI_PLOTCONTAINER_TOOLBOX_STAR_LOCALITY = "UI_PLOTCONTAINER_TOOLBOX_STAR_LOCALITY";
export const UI_PLOTCONTAINER_TOOLBOX_STAR_METALLICITY = "UI_PLOTCONTAINER_TOOLBOX_STAR_METALLICITY";
export const UI_PLOTCONTAINER_TOOLBOX_GRAPH_SETUP = "UI_PLOTCONTAINER_TOOLBOX_GRAPH_SETUP";
export const UI_PLOTCONTAINER_TOOLBOX_GRAPH_ID = "UI_PLOTCONTAINER_TOOLBOX_ID";

export const UI_PLOTCONTAINER_LOCALITY_SELECTMODE = "UI_PLOTCONTAINER_LOCALITY_SELECTMODE";

export const UI_PLOTCONTAINER_RENDERGRIDLINES = "UI_PLOTCONTAINER_RENDERGRIDLINES";
export const UI_PLOTCONTAINER_AXISLABELS = "UI_PLOTCONTAINER_AXISLABELS";

export const UI_PLOTCONTAINER_XPADDING = "UI_PLOTCONTAINER_XPADDING";
export const UI_PLOTCONTAINER_YPADDING = "UI_PLOTCONTAINER_YPADDING";
export const UI_PLOTCONTAINER_POINTSIZE = "UI_PLOTCONTAINER_POINTSIZE";
export const UI_PLOTCONTAINER_POINTOPACITY = "UI_PLOTCONTAINER_POINTOPACITY";
...
export let _GAMEDATA_DEFAULT = {
    ...
    UI_PLOTCONTAINER_ACTIVE: 0,
    UI_PLOTCONTAINER_WIDTH: 500, 
    UI_PLOTCONTAINER_HEIGHT: 500,
    UI_PLOTCONTAINER_ZOOM_X: 3,
    UI_PLOTCONTAINER_ZOOM_Y: 3,
    UI_PLOTCONTAINER_OFFSET_X: 0,
    UI_PLOTCONTAINER_OFFSET_Y: 0,
    UI_PLOTCONTAINER_MAXPOINTS: 1000,
    UI_PLOTCONTAINER_XKEY: "magnitude",
    UI_PLOTCONTAINER_YKEY: "bv",
    UI_PLOTCONTAINER_POINTSIZE: 1,
    UI_PLOTCONTAINER_POINTOPACITY: 1,
    UI_PLOTCONTAINER_XPADDING: 25,
    UI_PLOTCONTAINER_YPADDING: 25,
    UI_PLOTCONTAINER_FILTERMODE_STARS: 0,
    UI_PLOTCONTAINER_FILTERMODE_GRAPH: 0,
    UI_PLOTCONTAINER_IDSYSTEM_STARS: 0,
    UI_PLOTCONTAINER_IDSYSTEM_GRAPH: 0,
    UI_PLOTCONTAINER_HIDEGRAPH: 0,
    UI_PLOTCONTAINER_HIDECONTROLS: 0,
    UI_PLOTCONTAINER_SELECTRADIUS: 20,
    UI_PLOTCONTAINER_LOCALITY_SELECTMODE: 0,
    UI_PLOTCONTAINER_TOOLBOX_STAR_STYLE: 0,
