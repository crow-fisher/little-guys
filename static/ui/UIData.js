...
export let _GAMEDATA_DEFAULT = {
    ...
    UI_GAME_MAX_CANVAS_SQUARES_X: 1000,
    UI_GAME_MAX_CANVAS_SQUARES_Y: 1000,
    ...
    UI_LIGHTING_SUN: 2.3055555555555554,
    UI_LIGHTING_MOON: -2.3541666666666665,
    UI_LIGHTING_WATER: 0.5,
    UI_LIGHTING_ROCK: .38,
    UI_LIGHTING_PLANT: 1.5238095238095237,
    UI_LIGHTING_PLANT_GRASS: 1,
    UI_LIGHTING_PLANT_TREE: 0,
    UI_LIGHTING_DECAY: 17.63888888888889,
    ...
    UI_LIGHTING_GLOBAL: 1,
    UI_LIGHTING_DISABLED_BRIGHTNESS: 1,
    ...
    UI_LIGHTING_CLOUDCOVER_OPACITY: 0.1,
    ...
    UI_LIGHTING_FLATLIGHTING_SATURATION: 1,
    UI_LIGHTING_PLANTLIGHTINGOFFSET: (1 / Math.E)
};
...
let UI_SINGLE_GROUPS = [
    [UI_SM_BB, UI_PALETTE_ACTIVE, UI_SM_LIGHTING, UI_SM_ORGANISM, UI_SM_GODMODE, UI_SM_CLIMATE, UI_CLIMATE_SELECT_CLOUDS],
