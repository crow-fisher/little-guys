...
export const UI_TOPBAR_PERFORMANCE = "UI_TOPBAR_PERFORMANCE";
...
export const UI_PERFORMANCE_SIMPLESQUARE = "UI_PERFORMANCE_SIMPLESQUARE";
export const UI_PERFORMANCE_CLOUDS = "UI_PERFORMANCE_CLOUDS";
...
var UI_SINGLE_GROUPS = [
    ...
    [UI_TOPBAR_MAINMENU, UI_TOPBAR_BLOCK, UI_TOPBAR_VIEWMODE, UI_TOPBAR_LIGHTING],
    [UI_BB_MIXER, UI_BB_EYEDROPPER],
    [UI_TOPBAR_BLOCK, UI_TOPBAR_MAINMENU],
    [UI_SM_ORGANISM, UI_TOPBAR_PERFORMANCE],
