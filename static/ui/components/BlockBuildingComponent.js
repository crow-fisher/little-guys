...
import { loadUI, saveUI, UI_BB_EYEDROPPER, UI_BB_MIXER, UI_BB_MODE, UI_BB_SIZE, UI_BB_STRENGTH, UI_CENTER, UI_MODE_ROCK, UI_MODE_SOIL, UI_ROCK_COMPOSITION, UI_SOIL_COMPOSITION } from "../UIData.js";
...
export class BlockBuildingComponent extends Component {
    constructor(posX, posY, padding, dir, key) {
        ...
        container.addElement(new Radio(this.window, sizeX, getBaseUISize() * 3, UI_CENTER, UI_BB_MODE, [UI_MODE_SOIL, UI_MODE_ROCK],() => getActiveClimate().getUIColorInactive(), () => getActiveClimate().getUIColorActive()));
        ...
        specialToolContainer.addElement(new Toggle(this.window,sizeX / 2, getBaseUISize() * 2.5, UI_CENTER,UI_BB_EYEDROPPER , "q | eyedropper", () => getActiveClimate().getUIColorInactive(), () => getActiveClimate().getUIColorTransient()));
        specialToolContainer.addElement(new Toggle(this.window,sizeX / 2, getBaseUISize() * 2.5, UI_CENTER,UI_BB_MIXER , "w | mixer", () => getActiveClimate().getUIColorInactive(), () => getActiveClimate().getUIColorTransient()));
    }
