...
export class ClimateSubtreeComponent extends SubTreeComponent {
    constructor(posXFunc, posYFunc, padding, dir, key) {
        ...
        subMenuContainer.addElement(new Toggle(this.window, getBaseUISize() * 25 + textAlignOffsetX, getBaseUISize() * 3, textAlignOffsetX, UI_SM_CLIMATE, "old climate menu",() => getActiveClimate().getUIColorInactiveCustom(0.55), () => getActiveClimate().getUIColorActive()));
