...
import { loadGD, UI_LIGHTING_SUN, UI_LIGHTING_MOON, UI_LIGHTING_WATER, UI_LIGHTING_ROCK, UI_LIGHTING_PLANT, UI_LIGHTING_DECAY, UI_SM_LIGHTING, UI_SOIL_COMPOSITION, UI_CENTER, UI_LIGHTING_SURFACE, UI_LIGHTING_WATER_OPACITY, UI_LIGHTING_WATER_SATURATION, UI_LIGHTING_WATER_VALUE, UI_LIGHTING_WATER_HUE } from "../UIData.js";
...
export class LightingComponent extends Component {
    constructor(posX, posY, padding, dir, key) {
        ...
        rightContainer.addElement(new Slider(this.window, UI_LIGHTING_DECAY, sizeX,  35, 0.5, 800, () => getActiveClimate().getUIColorTransient()));
