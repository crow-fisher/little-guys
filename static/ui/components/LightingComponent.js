...
export class LightingComponent extends Component {
    constructor(posX, posY, padding, dir, key) {
        ...
        decayConditionalContainer.addElement(new SliderGradientBackground(this.window, UI_LIGHTING_PLANT, sizeX, sliderSizeY, -300, 30, getPlantColorDark, getPlantColor));
