...
export class BlockPalette extends Component {
    constructor(posX, posY, padding, dir, key) {
        ...
        soilRockContainer.addElement(new Text(this.window, sizeX, h2, UI_CENTER, "brush variance"));
        soilRockContainer.addElement(new SliderGradientBackground(this.window, UI_PALETTE_VARIANCE, sizeX, h2, 0, 1, () => "rgba(0,0,0,0)", () => "rgba(255, 255, 255, 1)"));
        ...
        specialContainer.addElement(new SliderGradientBackground(this.window, UI_LIGHTING_SURFACE, sizeX, 35, -4, 4, () => "rgba(0, 0, 0, 0)", () => "#FFFFFF",));
        // end surface
