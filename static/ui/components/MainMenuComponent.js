...
import { loadGD, loadUI, saveUI, UI_CENTER, UI_MAIN_NEWWORLD, UI_UI_SHOWHIDDEN, UI_UI_WORLDPAGE, UI_UI_CURWORLD, UI_UI_NEXTWORLD, UI_UI_SIZE, UI_UI_WORLDHIDDEN, UI_UI_WORLDNAME, UICONFIG, UI_UI_WORLDDELETED, saveGD, UI_UI_PHONEMODE, getGAMEDATA, UI_ORGANISM_LINEAGE_MAP } from "../UIData.js";
...
export class MainMenuComponent extends SubTreeComponent {
    constructor(posXFunc, posYFunc, padding, dir, key) {
        ...
        if (DEBUG) {
            subMenuContainer.addElement(new Button(this.window, this.sizeX, getBaseUISize() * 3, this.textAlignOffsetX, () => {
            ...
            }, "log GAMEDATA", () => getActiveClimate().getUIColorInactive(0.64)));
