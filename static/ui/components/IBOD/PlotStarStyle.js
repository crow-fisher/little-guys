...
import { UI_CENTER, UI_SH_MINSIZE, UI_STARMAP_STAR_CONTROL_TOGGLE_MODE } from "../../UIData.js";
...
export function addPlotStarStyleToContainer(window, container, sizeX, sizeY) {
    ...
    container.addElement(new SliderGradientBackground(window, UI_SH_MINSIZE, sizeX, textHeight, 1, 20, () => COLOR_WHITE, () => COLOR_BLACK));
}