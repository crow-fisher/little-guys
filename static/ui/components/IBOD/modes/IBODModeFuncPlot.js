...
export function IBODModeFuncPlot(_this, container, sizeX, sizeY) {
    ...
    row.addElement(new ButtonFunctionalText(
        _this.window, buttonWidth, getBaseUISize() * 3, UI_CENTER, () => getIBODComponent().plotStarScatter.resetValueRange(),
