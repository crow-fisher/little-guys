...
export class IBODComponent extends Component {
    constructor(posX, posY, padding, dir, key) {
        ...
        container.addElement(new TextBackground(this.window, this.sizeX, h1, UI_CENTER, () => getActiveClimate().getUIColorInactiveCustom(0.55), .75, "IBDO manager"))
        ...
        modeSelectRow.addElement(new Toggle(this.window, fifth, h2, UI_CENTER, UI_IBOD_MODE_EVENTS, "events", () => getActiveClimate().getUIColorInactiveCustom(0.55), () => getActiveClimate().getUIColorActive(0.55)));
        ...
        let plotConditionalContainer = new ConditionalContainer(this.window, 0, 1, () => loadGD(UI_IBOD_MODE_EVENTS));
        ...
        IBODModeFuncEvents(this, plotConditionalContainer, this.sizeX, plotSizeY);
