...
export class OrganismComponent extends Component {
     constructor(posX, posY, padding, dir, key) {
          ...
          grassConditionalContainer.addElement(new TextBackground(this.window, sizeX, br, offsetX, () => getActiveClimate().getUIColorInactiveCustom(0.85), 0.75, ""))
          ...
          wheatConditionalContainer.addElement(new TextBackground(this.window, sizeX, br, offsetX, () => getActiveClimate().getUIColorInactiveCustom(0.85), 0.75, ""))
          ...
          kblueConditionalContainer.addElement(new TextBackground(this.window, sizeX, br, offsetX, () => getActiveClimate().getUIColorInactiveCustom(0.85), 0.75, ""))
          ...
          cattailConditionalContainer.addElement(new TextBackground(this.window, sizeX, br, offsetX, () => getActiveClimate().getUIColorInactiveCustom(0.85), 0.75, ""))
          ...
          container.addElement(new TextBackground(this.window, sizeX, br, offsetX, () => getActiveClimate().getUIColorInactiveCustom(0.85), 0.75, ""))
          ...
          container.addElement(new TextBackground(this.window, sizeX, Math.floor(br/2) , offsetX, () => getActiveClimate().getUIColorInactiveCustom(0.58), 0.75, ""))
