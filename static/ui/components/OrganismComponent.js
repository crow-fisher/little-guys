...
export class OrganismComponent extends Component {
     constructor(posX, posY, padding, dir, key) {
          ...
          container.addElement(new TextBackground(this.window, sizeX, getBaseUISize() * 3.8, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.55), 0.66315, "plant editor"))
          ...
          container.addElement(new TextBackground(this.window, sizeX, br2, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""));
          ...
          modeSelectRow2.addElement(new RadioToggleLabel(this.window, half, h1, offsetX, "trees", UI_ORGANISM_TYPE_SELECT, UI_ORGANISM_TYPE_TREE,
               () => getActiveClimate().getUIColorInactive(0.59), () => getActiveClimate().getUIColorInactive(0.50)));
          ...
          grassConditionalContainer.addElement(new RadioToggleLabel(this.window, sizeX, h1, offsetX, "wheat", UI_ORGANISM_SELECT, UI_ORGANISM_GRASS_WHEAT,
               () => getActiveClimate().getUIColorInactive(0.60), () => getActiveClimate().getUIColorInactive(0.52)));
          grassConditionalContainer.addElement(new RadioToggleLabel(this.window, sizeX, h1, offsetX, "base grass", UI_ORGANISM_SELECT, UI_ORGANISM_GRASS_BASE,
               () => getActiveClimate().getUIColorInactive(0.63), () => getActiveClimate().getUIColorInactive(0.53)));
          grassConditionalContainer.addElement(new RadioToggleLabel(this.window, sizeX, h1, offsetX, "cattail", UI_ORGANISM_SELECT, UI_ORGANISM_GRASS_CATTAIL,
               () => getActiveClimate().getUIColorInactive(0.68), () => getActiveClimate().getUIColorInactive(0.52)));
          grassConditionalContainer.addElement(new TextBackground(this.window, sizeX, br2, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))

          let wheatConditionalContainer = new ConditionalContainer(this.window, 0, 1, () => loadGD(UI_ORGANISM_SELECT) == UI_ORGANISM_GRASS_WHEAT);
          let kblueConditionalContainer = new ConditionalContainer(this.window, 0, 1, () => loadGD(UI_ORGANISM_SELECT) == UI_ORGANISM_GRASS_BASE);
          ...
          wheatConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "wheat: the cereal central to life", "italic"))
          wheatConditionalContainer.addElement(new TextBackground(this.window, sizeX, br3, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))
          wheatConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.50), 0.75, "drained soils, full sun"))
          wheatConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "growing time: 2 cycles"))

          kblueConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "kentucky blue: a boring grass", "italic"))
          kblueConditionalContainer.addElement(new TextBackground(this.window, sizeX, br3, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))
          kblueConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.50), 0.75, "drained soils, partial sun"))
          kblueConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "growing time: 1 cycle"))

          cattailConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "cattails: the forbidden corndogs", "italic"))
          cattailConditionalContainer.addElement(new TextBackground(this.window, sizeX, br3, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))
          ...
          let baseLeafNodeConditionalContainer = new ConditionalContainer(this.window, 0, 1, () => loadGD(UI_ORGANISM_SELECT) == UI_ORGANISM_FLOWER_LEAFNODE);
          flowerConditionalContainer.addElement(baseLeafNodeConditionalContainer);

          baseLeafNodeConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "leaf node flower"))
          baseLeafNodeConditionalContainer.addElement(new TextBackground(this.window, sizeX, br3, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))
          baseLeafNodeConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.50), 0.75, "drained soils, partial sun"))
          baseLeafNodeConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "growing time: 1 cycle"))

          flowerConditionalContainer.addElement(new RadioToggleLabel(this.window, sizeX, h1, offsetX, "sunflower", UI_ORGANISM_SELECT, UI_ORGANISM_FLOWER_LEAFNODE_SUNFLOWER,
               () => getActiveClimate().getUIColorInactive(0.60), () => getActiveClimate().getUIColorInactive(0.52)));
          flowerConditionalContainer.addElement(new TextBackground(this.window, sizeX, br2, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))

          let sunflowerConditionalContainer = new ConditionalContainer(this.window, 0, 1, () => loadGD(UI_ORGANISM_SELECT) == UI_ORGANISM_FLOWER_LEAFNODE_SUNFLOWER);
          flowerConditionalContainer.addElement(sunflowerConditionalContainer);

          sunflowerConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, UI_CENTER, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "sunflower"))
          sunflowerConditionalContainer.addElement(new TextBackground(this.window, sizeX, br3, offsetX, () => getActiveClimate().getUIColorInactive(0.85), 0.75, ""))
          sunflowerConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.50), 0.75, "drained soils, full sun"))
          sunflowerConditionalContainer.addElement(new TextBackground(this.window, sizeX, h2, offsetX, () => getActiveClimate().getUIColorInactive(0.55), 0.75, "growing time: 1 cycle"))
          ...
          c_llt_min.addElement(new TextBackground(this.window, left, h1, offsetX, () => getActiveClimate().getUIColorInactive(0.58), 0.75, "llt_min"));
          c_llt_min.addElement(new TextFunctionalBackground(this.window, right, h1, offsetX, () => this.getGenericNutritionParam(_llt_min), () => getActiveClimate().getUIColorInactive(0.58)));
          nutrientConfiguratorContainer.addElement(new SliderGradientBackgroundGetterSetter(this.window,
          ...
          c_llt_max.addElement(new TextBackground(this.window, left, h1, offsetX, () => getActiveClimate().getUIColorInactive(0.58), 0.75, "llt_max"));
          c_llt_max.addElement(new TextFunctionalBackground(this.window, right, h1, offsetX, () => this.getGenericNutritionParam(_llt_max), () => getActiveClimate().getUIColorInactive(0.58)));
          nutrientConfiguratorContainer.addElement(new SliderGradientBackgroundGetterSetter(this.window,
          ...
          c_llt_tv_max.addElement(new TextBackground(this.window, left, h1, offsetX, () => getActiveClimate().getUIColorInactive(0.58), 0.75, "llt_throttlValMax"));
          c_llt_tv_max.addElement(new TextFunctionalBackground(this.window, right, h1, offsetX, () => this.getGenericNutritionParam(_llt_throttlValMax), () => getActiveClimate().getUIColorInactive(0.58)));
          nutrientConfiguratorContainer.addElement(new SliderGradientBackgroundGetterSetter(this.window,
          ...
          c_seedReduction.addElement(new TextBackground(this.window, left, h1, offsetX, () => getActiveClimate().getUIColorInactive(0.58), 0.75, "seedReduction"));
          ...
          c_waterTarget.addElement(new TextFunctionalBackground(this.window, right, h1, offsetX, () => this.getGenericNutritionParam(_waterPressureSoilTarget), () => getActiveClimate().getUIColorInactive(0.58)));
          nutrientConfiguratorContainer.addElement(new SliderGradientBackgroundGetterSetter(this.window,
          ...
          c_overwaterThresh.addElement(new TextBackground(this.window, left, h1, offsetX, () => getActiveClimate().getUIColorInactive(0.58), 0.75, "overwaterThresh"));
     ...
     isOrganismSelectedOnCurrentPage() {
          ...
          if (loadGD(UI_ORGANISM_TYPE_SELECT) == UI_ORGANISM_TYPE_FLOWER) {
               if ([UI_ORGANISM_FLOWER_LEAFNODE, UI_ORGANISM_FLOWER_LEAFNODE_SUNFLOWER].includes(selected)) {
                    return true;
               }
               return false;
          }
          ...
          if (loadGD(UI_ORGANISM_TYPE_SELECT) == UI_ORGANISM_TYPE_GRASS) {
               if ([UI_ORGANISM_GRASS_CATTAIL, UI_ORGANISM_GRASS_BASE, UI_ORGANISM_GRASS_WHEAT].includes(selected)) {
                    return true;
               }
               return false;
          }
