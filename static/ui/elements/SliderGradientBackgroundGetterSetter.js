...
export class SliderGradientBackgroundGetterSetter extends WindowElement {
    constructor(window, getter, setter, sizeX, sizeY, min, max, minColorFunc, maxColorFunc, renderSkyBackground=false) {
