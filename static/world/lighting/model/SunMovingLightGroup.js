...
import { getCurDay, getCurrentLightColorTemperature, getDaylightStrength, millis_per_day } from "../../time/time.js";
    ...
    init() {
        ...
        for (let i = 0; i < this.numNodes; i += 1) {
            let newLightSource = new MovingLightSource(
                ...
                () => getDaylightStrength() * Math.exp(loadGD(UI_LIGHTING_SUN)),
