...
export class StarHandler {
    ...
    valueWatchTick() {
        ...
        this.colorWatchValues = {
            ...
            UI_SH_STYLE_SIZE_A: loadGD(UI_SH_STYLE_SIZE_A),
            UI_SH_STYLE_BRIGHTNESS_B: loadGD(UI_SH_STYLE_BRIGHTNESS_B),
            UI_SH_STYLE_SIZE_B: loadGD(UI_SH_STYLE_SIZE_B),
            UI_SH_STYLE_BRIGHTNESS_A: loadGD(UI_SH_STYLE_BRIGHTNESS_A)
        }
    }
