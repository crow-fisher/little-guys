...
export class Climate {
    constructor() {
        ...
        let rockColorBaseArr = ["#3c4786ff", "#030003ff", "#828297ff"];
        ...
        this.weatherPatternMap.set(UI_CLIMATE_WEATHER_LIGHTRAIN, 15);
        this.weatherPatternMap.set(UI_CLIMATE_WEATHER_HEAVYRAIN, 5);
