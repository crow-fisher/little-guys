...
import { loadGD, saveGD, UI_PALETTE_SIZE, UI_PALETTE_STRENGTH, UI_UI_SIZE, UI_PALETTE_BLOCKS, loadUI, UI_PALETTE_SURFACE_LIGHTING_FACTOR, UI_PALETTE_SELECT, UI_GAME_MAX_CANVAS_SQUARES_X, UI_GAME_MAX_CANVAS_SQUARES_Y, UI_CANVAS_VIEWPORT_CENTER_X, UI_CANVAS_VIEWPORT_CENTER_Y, UI_CANVAS_SQUARES_ZOOM, UI_CANVAS_VIEWPORT_FRAC_X, UI_CANVAS_VIEWPORT_FRAC_Y, UI_CAMERA_OFFSET_VEC, UI_CAMERA_OFFSET_VEC_DT, UI_VIEWMODE_SELECT, UI_VIEWMODE_3D, UI_CAMERA_ROTATION_VEC, UI_CAMERA_ROTATION_VEC_DT, addUIFunctionMap, UI_PALETTE_SURFACE, UI_LIGHTING_SURFACE_LIGHTING_FACTOR, UI_LIGHTING_SURFACE } from "./ui/UIData.js";
...
export function zoom(event) {
    ...
    if (loadGD(UI_PALETTE_BLOCKS)) {
        if (loadGD(UI_PALETTE_SELECT) == UI_PALETTE_SURFACE) {
                saveGD(UI_LIGHTING_SURFACE, loadGD(UI_LIGHTING_SURFACE) + event.deltaY * .005);
                return;
        }
        if (loadGD(UI_PALETTE_SELECT) == UI_PALETTE_SURFACE_LIGHTING_FACTOR)  {
                saveGD(UI_LIGHTING_SURFACE_LIGHTING_FACTOR, loadGD(UI_LIGHTING_SURFACE_LIGHTING_FACTOR) + event.deltaY * .005);
                return;
        }

        if (isKeyPressed(KEY_SHIFT)) {
            if (loadGD(UI_PALETTE_SELECT) == loadGD(UI_PALETTE_SURFACE_LIGHTING_FACTOR)) {
