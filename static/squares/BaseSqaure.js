...
export class BaseSquare {
    ...
    render() {
        ...
        } else if (selectedViewMode == UI_VIEWMODE_ORGANISMS || selectedViewMode == UI_VIEWMODE_EVOLUTION) {
