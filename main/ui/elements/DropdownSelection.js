...
export class DropdownSelection extends WindowElement {
    constructor(window, sizeX, sizeY, offsetX, key, optionsArrKeyFunc, optionsArrLabelFunc, fillFillStyleFunc, fontSizeMult=0.75, textFillStyle=COLOR_BLACK) {
