...
export const UI_STARMAP_CONSTELLATION_BRIGHTNESS = "UI_STARMAP_CONSTELLATION_BRIGHTNESS";
...
export const UI_IBOD_PLOT_ACTIVE = "UI_IBOD_PLOT_ACTIVE";

export const UI_IBOD_MODE_LABEL = "UI_AA_MODE_LABEL";
export const UI_IBOD_MODE_EVENTS = "UI_AA_MODE_PLOT";
export const UI_IBOD_MODE_STYLE = "UI_AA_MODE_STYLE";
export const UI_IBOD_MODE_SETUP = "UI_AA_MODE_SETUP";
export const UI_IBOD_MODE_SELECT = "UI_AA_MODE_SELECT";

export const UI_IBOD_PLOT_CONFIGURE = "UI_IBOD_PLOT_CONFIGURE";
export const UI_IBOD_PLOT_PARAMS = "UI_IBOD_PLOT_PARAMS";
export const UI_IBOD_PLOT_WIDTH = "UI_IBOD_PLOT_WIDTH";
export const UI_IBOD_PLOT_HEIGHT = "UI_IBOD_PLOT_HEIGHT";
export const UI_IBOD_PLOT_MAXPOINTS = "UI_IBOD_PLOT_MAXPOINTS";
export const UI_IBOD_PLOT_XKEY = "UI_IBOD_PLOT_XKEY";
export const UI_IBOD_PLOT_YKEY = "UI_IBOD_PLOT_YKEY";
export const UI_IBOD_PLOT_ZOOM_X = "UI_IBOD_PLOT_ZOOM_X";
export const UI_IBOD_PLOT_ZOOM_Y = "UI_IBOD_PLOT_ZOOM_Y";
export const UI_IBOD_PLOT_OFFSET_X = "UI_IBOD_PLOT_OFFSET_X";
export const UI_IBOD_PLOT_OFFSET_Y = "UI_IBOD_PLOT_OFFSET_Y";
export const UI_IBOD_PLOT_SELECTRADIUS = "UI_IBOD_PLOT_SELECTRADIUS";
export const UI_IBOD_PLOT_SELECT_NAMED_STARS = "UI_IBOD_PLOT_SELECT_NAMED_STARS";

export const UI_IBOD_SELECT_FILTERMODE_GRAPH = "UI_IBOD_SELECT_FILTERMODE_GRAPH";
export const UI_IBOD_SELECT_FILTERMODE_STARS = "UI_IBOD_SELECT_FILTERMODE_STARS";
export const UI_IBOD_SELECT_FILTERMODE_GRAPH_PREPARED = "UI_IBOD_SELECT_FILTERMODE_GRAPH_PREPARED";
export const UI_IBOD_LABEL_STARS = "UI_IBOD_LABEL_STARS";
export const UI_IBOD_LABEL_GRAPH = "UI_IBOD_LABEL_GRAPH";
export const UI_IBOD_PLOT_HIDEGRAPH = "UI_IBOD_PLOT_HIDEGRAPH";
export const UI_IBOD_PLOT_HIDECONTROLS = "UI_IBOD_PLOT_HIDECONTROLS";

export const UI_IBOD_PLOT_TOOLBOX_STAR_STYLE = "UI_IBOD_PLOT_TOOLBOX_STAR_STYLE";
export const UI_IBOD_PLOT_TOOLBOX_STAR_LOCALITY = "UI_IBOD_PLOT_TOOLBOX_STAR_LOCALITY";
export const UI_IBOD_PLOT_TOOLBOX_STAR_METALLICITY = "UI_IBOD_PLOT_TOOLBOX_STAR_METALLICITY";
export const UI_IBOD_PLOT_TOOLBOX_GRAPH_SETUP = "UI_IBOD_PLOT_TOOLBOX_GRAPH_SETUP";
export const UI_IBOD_PLOT_TOOLBOX_GRAPH_ID = "UI_IBOD_PLOT_TOOLBOX_ID";

export const UI_IBOD_PLOT_LOCALITY_SELECTMODE = "UI_IBOD_PLOT_LOCALITY_SELECTMODE";

export const UI_IBOD_PLOT_RENDERGRIDLINES = "UI_IBOD_PLOT_RENDERGRIDLINES";
export const UI_IBOD_PLOT_AXISLABELS = "UI_IBOD_PLOT_AXISLABELS";

export const UI_IBOD_PLOT_XPADDING = "UI_IBOD_PLOT_XPADDING";
export const UI_IBOD_PLOT_YPADDING = "UI_IBOD_PLOT_YPADDING";
export const UI_IBOD_PLOT_POINTSIZE = "UI_IBOD_PLOT_POINTSIZE";
export const UI_IBOD_PLOT_POINTOPACITY = "UI_IBOD_PLOT_POINTOPACITY";
export const UI_IBOD_SELECTED_OPACITY = "UI_IBOD_SELECTED_OPACITY";
...
export const UI_ORGANISM_CURID = "UI_ORGANISM_CURID";
...
export const UI_ORGANISM_SOUP_GRASS = "UI_ORGANISM_SOUP_GRASS";
...
export const UI_VIEWMODE_PROJECTION = "UI_VIEWMODE_PROJECTION";
export const UI_VIEWMODE_SELECT = "UI_VIEWMODE_SELECT";

export const UI_VIEWMODE_BLOCK_SELECT = "UI_VIEWMODE_BLOCK_SELECT";
export const UI_VIEWMODE_BLOCK_NORMAL = "UI_VIEWMODE_BLOCK_NORMAL"
export const UI_VIEWMODE_BLOCK_WATERTICKRATE = "UI_VIEWMODE_BLOCK_WATERTICKRATE";
export const UI_VIEWMODE_BLOCK_WATERMATRIC = "UI_VIEWMODE_BLOCK_WATERMATRIC";
export const UI_VIEWMODE_BLOCK_MOISTURE = "UI_VIEWMODE_BLOCK_MOISTURE";
export const UI_VIEWMODE_BLOCK_GROUP = "UI_VIEWMODE_BLOCK_GROUP";

export const UI_VIEWMODE_ORG_LIFETIME = "UI_VIEWMODE_ORG_LIFETIME";
export const UI_VIEWMODE_ORG_GROWTH = "UI_VIEWMODE_ORG_GROWTH"
export const UI_VIEWMODE_ORG_MOISTURE = "UI_VIEWMODE_ORG_MOISTURE";
export const UI_VIEWMODE_ORG_LIGHTING = "UI_VIEWMODE_ORG_LIGHTING";
export const UI_VIEWMODE_ORG_DENSITY = "UI_VIEWMODE_ORG_DENSITY";

export const UI_VIEWMODE_PROJECTION_2D = "UI_VIEWMODE_PROJECTION_2D";
export const UI_VIEWMODE_PROJECTION_3D = "UI_VIEWMODE_PROJECTION_3D";

export const UI_VIEWMODE_3D = "UI_VIEWMODE_3D"; // deprecated
...
export const UI_TOPBAR_AA = "UI_TOPBAR_AA";
export const UI_TOPBAR_IBOD = "UI_TOPBAR_IBOD";
export const UI_WORLDPAN = "UI_WORLDPAN";

export const UI_NAME = "UI_NAME";

export const UI_SPEED = "UI_SPEED";
export const UI_SPEED_ZERO = 0;
export const UI_SPEED_ONE = 1;
export const UI_SPEED_TWO = 2;
export const UI_SPEED_THREE = 3;
export const UI_SPEED_FOUR = 4;
export const UI_SPEED_FIVE = 5;
export const UI_SPEED_SIX = 6;
export const UI_SPEED_SEVEN = 7;
export const UI_SPEED_EIGHT = 8;
export const UI_SPEED_NINE = 9;
export const UI_SPEED_TEN = 10;
export const UI_SPEED_ELEVEN = 11;
export const UI_SPEED_TWELVE = 12;
export const UI_SPEED_THIRTTEEN = 13;
export const UI_SPEED_FOURTTEEN = 14;
export const UI_SPEED_FIFTEEN = 15;
export const UI_SPEED_SIXTEEN = 16;
export const UI_SPEED_SEVENTEEN = 17;
export const UI_SPEED_EIGHTTEEN = 18;
export const UI_SPEED_NINETEEEN = 19;

export const UI_SPEEDS = [UI_SPEED, UI_SPEED_ZERO, UI_SPEED_ONE, UI_SPEED_TWO, UI_SPEED_THREE, UI_SPEED_FOUR, UI_SPEED_FIVE, UI_SPEED_SIX, UI_SPEED_SEVEN, UI_SPEED_EIGHT, UI_SPEED_NINE, UI_SPEED_TEN, UI_SPEED_ELEVEN]; //, UI_SPEED_12]; //,UI_SPEED_13, UI_SPEED_14, UI_SPEED_15, UI_SPEED_16, UI_SPEED_17, UI_SPEED_18, UI_SPEED_19 ]
...
export const UI_IBOD_PLAYERUUID = "UI_IBOD_PLAYERUUID";
export const UI_IBOD_PUBKEY = "UI_IBOD_PUBKEY";
export const UI_IBOD_PRIVKEY = "UI_IBOD_PRIVKEY";


////// params from rewrite 5/29/26

export const UI_COMPONENT_DATA = "UI_COMPONENT_DATA";
...
export let _GAMEDATA_DEFAULT = {
    ...
    UI_IBOD_PLOT_WIDTH: 60,
    UI_IBOD_PLOT_HEIGHT: 41.99658203125,
    UI_IBOD_PLOT_ZOOM_X: 3,
    UI_IBOD_PLOT_ZOOM_Y: 3,
    UI_IBOD_PLOT_OFFSET_X: 0,
    UI_IBOD_PLOT_OFFSET_Y: 0,
    UI_IBOD_PLOT_MAXPOINTS: 1000,
    UI_IBOD_PLOT_XKEY: "magnitude",
    UI_IBOD_PLOT_YKEY: "bv",
    UI_IBOD_PLOT_POINTSIZE: 1,
    UI_IBOD_PLOT_POINTOPACITY: 1,
    UI_IBOD_PLOT_XPADDING: 25,
    UI_IBOD_PLOT_YPADDING: 25,
    UI_IBOD_SELECT_FILTERMODE_STARS: 0,
    UI_IBOD_SELECT_FILTERMODE_GRAPH: 0,
    UI_IBOD_LABEL_STARS: 0,
    UI_IBOD_LABEL_GRAPH: 0,
    UI_IBOD_PLOT_HIDEGRAPH: 0,
    UI_IBOD_PLOT_HIDECONTROLS: 0,
    UI_IBOD_PLOT_SELECTRADIUS: 20,
    UI_IBOD_PLOT_LOCALITY_SELECTMODE: 0,
    UI_IBOD_PLOT_TOOLBOX_STAR_STYLE: 0,
    UI_IBOD_SETUP_COLORMODE: "default",
    UI_IBOD_SETUP_MIN: 0,
    UI_IBOD_SETUP_WINDOW_SIZE: 1,
    UI_IBOD_SETUP_POW: 1,
    UI_IBOD_SETUP_MULT: 1,
    UI_IBOD_SETUP_SELECT_MULT: 1,
    ...
    UI_VIEWMODE_PROJECTION: UI_VIEWMODE_PROJECTION_3D,
    ...
    UI_STARMAP_CONSTELLATION_BRIGHTNESS: 0,
    UI_SH_MINSIZE: 4,
    ...
    UI_VIEWMODE_ORG_DENSITY: 4,
    UI_VIEWMODE_ORG_LIFETIME: 1,
    UI_VIEWMODE_ORG_GROWTH: 1,
    UI_VIEWMODE_ORG_LIGHTING: 1,
    UI_VIEWMODE_ORG_MOISTURE: 0,
...
export function getNextOrganismId() {
    saveUI(UI_ORGANISM_CURID, loadUI(UI_ORGANISM_CURID) + 1);
    return loadUI(UI_ORGANISM_CURID);
}
