...
export class StargazerComponent extends LockedComponent {
    constructor(posXFunc, posYFunc, padding, dir, key) {
        ...
        container.addElement(new SliderGradientBackground(this.window, UI_STARMAP_CONSTELLATION_BRIGHTNESS, sizeX, sliderHeight, 0, 8, () => COLOR_WHITE, () => COLOR_BLACK));
