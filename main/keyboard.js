...
export function keyboard3DRoutine() {
    ...
    // if (key == 'u') {
    //     saveGD(UI_STARMAP_CONSTELLATION_BRIGHTNESS, loadGD(UI_STARMAP_CONSTELLATION_BRIGHTNESS) - .01);
    // }
    // if (key === 'o') {
    //     saveGD(UI_STARMAP_CONSTELLATION_BRIGHTNESS, loadGD(UI_STARMAP_CONSTELLATION_BRIGHTNESS) + .01);
    // }
